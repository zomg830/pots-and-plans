...
export default function randomEvent() {
  ...
  switch (todaysEvent) {
    case "good_sleep":
      ...
      result.time = 0;
      result.message =
        "Your cook got a good night's sleep!!  Cooking Skill increases.";
      result.imageURL =
        "http://31.media.tumblr.com/9676f7b0d464eacbc2a06c796df97ccf/tumblr_mqc0tjK9le1qbcswco1_500.gif";
      break;
    case "bad_sleep":
      result.skill -= 2;
      result.balance = 0;
    ...
    case "convention":
      ...
      result.skill = 0;
      result.message =
        "There's a Convention this week!!  Walk-in traffic increases.";
    ...
    case "good_weather":
      ...
      result.time = 0;
      result.message =
        "The weather is perfect for getting a burger!!  Sales increase by 15%.";
      result.imageURL =
        "https://media0.giphy.com/media/QJJnTE1C1bKnz4Elxa/giphy.gif";
      break;
    case "inspection":
      result.balance -= 1000;
      result.skill = 0;
